...
- Added persistent managed-skill ownership state plus safe adoption of legacy lock sources, unchanged bundled copies, and the verified `obra/superpowers` fallback; restored `handoff` as a visible default-on Workflow choice.
