...
- Extended the `## License` section of both READMEs: this repository is MIT, but `lieflat-charts` is [PolyForm Noncommercial 1.0.0](https://github.com/larashero3-dotcom/lieflat-charts/blob/main/LICENSE) and is noncommercial-use only.
